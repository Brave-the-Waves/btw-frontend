...
export default function Donate({ preFillDonationId, preFillName, eventPage }) {
  return (
    <section id="donate" className="py-24 md:py-32 bg-gradient-to-b from-[#fc87a7]/10 to-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <DonateCards preFillDonationId={preFillDonationId} preFillName={preFillName} eventPage={eventPage} />
        {/* <Partnerships /> */}
