      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            A full day of racing, entertainment, and community celebration
          </p>
        </motion.div>
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    {index < schedule.length - 1 && (
                      <div className="w-0.5 h-full bg-gradient-to-b from-pink-300 to-pink-100 my-1" />
                    )}
                  </div>
                  <div className="pb-8">
        ...
        >
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.0977759013745!2d-122.39568388468185!3d37.78779997975772!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085807abad77c31%3A0x3f10d205e9ab87f2!2sSan%20Francisco%20Marina!5e0!3m2!1sen!2sus!4v1640000000000!5m2!1sen!2sus"
            width="100%"
            height="400"
            style={{ border: 0 }}
            allowFullScreen
