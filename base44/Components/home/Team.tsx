...
const teamMembers = [
  {
    ...
    bio: "10+ years organizing community events. Breast cancer survivor and dragon boat enthusiast."
  },
  {
    name: "Michael Torres",
    role: "Dragon Boat Club Liaison",
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80",
    bio: "Head coach at Harbor Dragon Boat Club. Certified IDBF coach with international racing experience."
  },
  {
    name: "Dr. Amanda Williams",
    role: "Health Partnership Lead",
    image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=80",
    bio: "Women's health advocate and practicing oncologist. Connects medical resources with community."
  },
  {
    name: "Jessica Park",
    role: "Marketing & Outreach",
    image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&q=80",
    bio: "Digital marketing strategist passionate about amplifying voices in women's health advocacy."
  },
  {
    name: "David Nakamura",
    role: "Operations Manager",
    image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=80",
    bio: "Logistics expert ensuring seamless race day operations. Former event coordinator for city marathons."
  },
  {
    name: "Lisa Rodriguez",
    role: "Volunteer Coordinator",
    image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&q=80",
    bio: "Community organizer who mobilizes 200+ volunteers annually. Builds bridges between teams and causes."
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Dedicated individuals steering Brave the Waves toward greater impact
          </p>
        </motion.div>
