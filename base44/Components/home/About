        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
              ...
              <span className="text-pink-500">Racing for Hope</span>
            </h2>
            <p className="text-lg text-slate-600 mb-6 leading-relaxed">
              Brave the Waves brings together passionate paddlers, survivors, and supporters 
              in an annual celebration of strength and solidarity. Our partnership with women's 
              health organizations creates meaningful impact in our community.
            </p>
            <p className="text-lg text-slate-600 leading-relaxed">
              What started as a small gathering of dragon boat enthusiasts has grown into 
              the region's most anticipated charity event. Every stroke of the paddle 
              represents hope, every race a step toward better healthcare access for all women.
            </p>
          </motion.div>
        </div>
