        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 leading-relaxed mb-6 max-w-sm">
              An annual dragon boat charity event raising awareness and funds for women's 
              health initiatives. Paddle with purpose.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 hover:bg-pink-500 flex items-center justify-center transition-colors">
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-sm">
            © {new Date().getFullYear()} Brave the Waves. All rights reserved.
          </p>
          <p className="text-slate-500 text-sm flex items-center gap-2">
            Made with <Heart className="w-4 h-4 text-pink-500" /> for women's health
          </p>
        </div>
      </div>
    </footer>
