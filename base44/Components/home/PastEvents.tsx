...
const pastEvents = [
  {
    ...
    raised: 125000,
    participants: 960,
    highlight: "Record-breaking attendance with 48 teams competing"
  },
  {
    year: "2023",
    ...
    raised: 98000,
    participants: 840,
    highlight: "First year with dedicated survivor team division"
  },
  {
    year: "2022",
    ...
    raised: 75000,
    participants: 700,
    highlight: "Expanded to include corporate challenge cup"
  },
  {
    year: "2021",
    ...
    raised: 52000,
    participants: 560,
    highlight: "Post-pandemic comeback celebration"
  },
];
  ...
  return (
    <section id="past-events" className="py-24 md:py-32 bg-slate-900 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-pink-500/20 text-pink-400 text-sm font-medium mb-6">
            Our Journey
          </span>
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            Celebrating years of community, courage, and collective impact
          </p>
        </motion.div>
        ...
        >
          {milestones.map((milestone, index) => (
            <motion.div
              ...
              className="text-center p-6 rounded-2xl bg-slate-800/50 border border-slate-700 hover:border-pink-500/50 transition-colors"
            >
        ...
        <div className="relative mb-20">
                ...
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="aspect-video md:aspect-auto">
                    <img 
                      ...
                      alt={`Event ${pastEvents[currentIndex].year}`}
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="bg-gradient-to-br from-pink-600 to-pink-700 p-8 md:p-12 flex flex-col justify-center">
                    <span className="text-6xl md:text-8xl font-bold text-white/20 absolute top-4 right-4 md:top-8 md:right-8">
                      {pastEvents[currentIndex].year}
                    </span>
                    <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">
                      {pastEvents[currentIndex].year} Event
                    </h3>
                    <p className="text-pink-100 mb-8 text-lg">
                      {pastEvents[currentIndex].highlight}
                    </p>
          ...
          <div className="flex justify-center gap-4 mt-8">
            <Button
              ...
              size="icon"
              onClick={prevSlide}
              className="rounded-full border-slate-700 bg-slate-800 hover:bg-slate-700 text-white"
            >
              ...
              {pastEvents.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all ${
                    index === currentIndex ? 'bg-pink-500 w-8' : 'bg-slate-600'
                  }`}
                />
              ))}
            </div>
